...
@Entity
@NamedQueries({
        @NamedQuery(name = AttributeSubscription.GetUsersByAttributeQuery,
        ...
        @NamedQuery(name = AttributeSubscription.GetExactSubscriptonQuery,
                query = "SELECT subs FROM AttributeSubscription subs LEFT JOIN subs.user u " +
                        ...
                        "subs.pattern in (:" + AttributeSubscription.PatternQueryParameter + ") and " +
                        "u.id=:" + AttributeSubscription.UserIdQueryParameter),
        ...
        @NamedQuery(name = AttributeSubscription.GetAllByUserIdQuery,
                query = "SELECT subs FROM AttributeSubscription subs LEFT JOIN subs.user u " +
                        "where  u.id=:" + AttributeSubscription.UserIdQueryParameter)
