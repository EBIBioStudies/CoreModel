...
@Entity
@NamedQueries({
        @NamedQuery(name = TagSubscriptionMatchEvent.GetAllUsersWithEventsQuery,
        ...
        @NamedQuery(name = TagSubscriptionMatchEvent.GetEventsByUserIdQuery,
                query = "SELECT se FROM TagSubscriptionMatchEvent se LEFT JOIN se.user u " +
                        ...
                        "where u.id=:" + TagSubscriptionMatchEvent.UserIdQueryParameter),

        @NamedQuery(name = TagSubscriptionMatchEvent.DeleteEventsByUserIdQuery,
                query="delete from TagSubscriptionMatchEvent se " +
                        "where se.user.id=:" + TagSubscriptionMatchEvent.UserIdQueryParameter)
})
...
public class TagSubscriptionMatchEvent {
    ...
    public TagSubscription getSubscription() { return subscription; }
