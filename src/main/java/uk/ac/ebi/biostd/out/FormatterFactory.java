...
public class FormatterFactory {
    ...
    public static AbstractFormatter getFormatter(FormatterType type,
                                                 Appendable o, boolean cut) throws Exception {
        switch (type) {
            case JSON: return new JSONFormatter(o, cut);
            case XML: return new PageMLFormatter(o, cut);
            default: throw new Exception(UNSUPPORTED + type.name());
        }
    }

    public static AbstractFormatter getFormatter(String type,
                                                 Appendable o, boolean cut) throws Exception {
        try {
