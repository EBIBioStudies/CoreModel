...
public class FileTableContext extends BlockContext
{

 public FileTableContext(Section lastSection, PageTabSyntaxParser2 prs, LogNode sln)
 {
  super(BlockType.FILETABLE,prs);
 }
