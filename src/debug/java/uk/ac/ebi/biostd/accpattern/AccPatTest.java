...
public class AccPatTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(str + " matches " + PageTabElements.ValueQualifierRx + " : " + Pattern
                .compile(PageTabElements.ValueQualifierRx).matcher(str).matches());

        str = "aa[ bb ]";

        System.out.println(
                str + " matches " + PageTabElements.TableBlockRx + " : " + Pattern.compile(PageTabElements.TableBlockRx)
                        .matcher(str).matches());
        ...
        while (true) {
            ...
            if (mtch.matches()) {
                System.out.println(
                        "TmpAcc='" + mtch.group("tmpid") + "' Pfx='" + mtch.group("pfx") + "' Sfx='" + mtch.group("sfx")
                                + "'");
            }
